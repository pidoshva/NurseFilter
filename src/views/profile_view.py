...
class ProfileView:
    ...
    def create_widgets(self):
        ...
        # Nurse Visit Log
        tk.Label(frame, text="Nurse Visit Log", font=("Arial",14,"bold")).pack(anchor='w', pady=(10,0))
        self.visit_tree = ttk.Treeview(frame, columns=("Nurse", "Time"), show='headings', height=6)
        ...
        tk.Button(btn_frame, text="Auto Log Visit", command=self.auto_log_visit).pack(side=tk.LEFT, padx=5)
        tk.Button(btn_frame, text="Manual Log Visit", command=self.manual_log_visit).pack(side=tk.LEFT, padx=5)
